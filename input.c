...
int main(void){
    ...
    int my_int1, my_int2;
    int return_code;
    fprintf(stdout, "This program will read in a double and two integers.\n");
    printf("Please enter a floating-point number: ");
    /*make sure output is immediately written to screen*/
    fflush(stdout);
    
    return_code = scanf("%lg", &my_double);
    /*return_code will be 1 if one double was read, 0 if nothing was successfully read, or EOF if the end of input was reached.*/
    if(return_code != 1){
